...
INSERT INTO Patient (Email, ContactNumber, DOB, Gender, Address, eWalletAmount, resetPasswordCode, PCHI, googleId, givenName, familyName, profilePicture)
VALUES 
('john.doe@example.com', '1234567890', '1985-01-15', 'Male', '123 Main St', 50.00, NULL, 2000.00, 'google123', 'John', 'Doe', 'https://example.com/john.jpg'),
('jane.smith@example.com', '0987654321', '1990-05-20', 'Female', '456 Elm St', 75.00, NULL, 3000.00, 'google456', 'Jane', 'Smith', 'https://example.com/jane.jpg'),
('alice.jones@example.com', '1122334455', '1988-09-30', 'Female', '789 Maple St', 100.00, NULL, 2500.00, 'google789', 'Alice', 'Jones', 'https://example.com/alice.jpg');
...
VALUES 
('Dr. Gregory House', 'house@example.com', 'password123', '1234567891', '1960-06-11', 'Male', 'Diagnostics', NULL),
('Dr. Meredith Grey', 'grey@example.com', 'password456', '0987654322', '1978-09-27', 'Female', 'General Surgery', NULL),
('Dr. John Watson', 'watson@example.com', 'password789', '1122334456', '1980-03-31', 'Male', 'Internal Medicine', NULL);
